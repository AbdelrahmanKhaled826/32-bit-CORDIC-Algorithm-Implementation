...
#set_input_delay -clock sys_clk 0.1 [get_ports i_cordic_mode]
#set_input_delay -clock sys_clk 0.1 [get_ports i_cordic_x]
#set_input_delay -clock sys_clk 0.1 [get_ports i_cordic_y]
#set_input_delay -clock sys_clk 0.1 [get_ports i_cordic_theta]

#set_output_delay -clock sys_clk 0.1 [get_ports o_codic_out1]
#set_output_delay -clock sys_clk 0.1 [get_ports o_codic_out2]

#set_property MAX_FANOUT 50 [get_ports i_cordic_rst_n]
#set_property MAX_FANOUT 50 [get_ports i_cordic_mode*]
...
set_property -dict { PACKAGE_PIN P26   IOSTANDARD LVCMOS33 } [get_ports { i_cordic_theta[22] }]; #IO_L10P_T1_D14_14 Sch=sw[6]
set_property -dict { PACKAGE_PIN P27   IOSTANDARD LVCMOS33 } [get_ports { i_cordic_theta[21] }]; #IO_L8P_T1_D11_14 Sch=sw[7]
